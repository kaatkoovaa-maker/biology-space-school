    ...
    <div className="mb-8 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
      <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-cyanGlow/12 via-transparent to-pinkGlow/10 p-5">
        ...
        <svg className="mt-4 h-48 w-full" viewBox="0 0 620 220" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {[
            { x: 42, y: 162, r: 18, c: "#7DF9FF", t: "старт" },
            { x: 128, y: 126, r: 20, c: "#58C6FF", t: "клетка" },
            { x: 216, y: 108, r: 22, c: "#FF7BE8", t: "код" },
            { x: 312, y: 138, r: 24, c: "#B285FF", t: "Вита" },
            { x: 406, y: 154, r: 26, c: "#7DFFB2", t: "человек" },
            { x: 494, y: 122, r: 28, c: "#FFC36A", t: "проект" },
            { x: 586, y: 58, r: 30, c: "#9DF7D2", t: "смысл" }
          ].map((item) => (
            <g key={item.t}>
        ...
        <div className="grid gap-3 text-sm text-slate-300 sm:grid-cols-3">
          <p>Протос, Цитара и Генезис дают Люмену базу: наблюдение, структуру и генетический код.</p>
          <p>На Витариуме он встречает Виту и впервые начинает расти не ради образа, а по-настоящему.</p>
          <p>Хоминис, Эволюс и Экосфера собирают его в зрелого человека со своим проектом и осознанным взглядом.</p>
        </div>
      </div>
